...
class AddCustomer:
    ...
    lnkCustomer_menitem_xpath="//a[@href='/Admin/Customer/List']//p[contains(text(),'Customers')]"
    ...
    tctDob_xpath="//input[@id='DateOfBirth']"
    txtCompanyName_xpath="//input[@id='Company']"
    txtcusstomerRoles_xpath="//div[@class='input-group-append input-group-required']"
    ...
    def clickOnCustomersMenuItem(self):
        self.driver.find_element_by_xpath(self.lnkCustomer_menitem_xpath).click()
    ...
    def setComapnyName(self,comname):
        self.driver.find_element_by_xpath(self.txtComapnyName_xpath).send_Keys(comname)
